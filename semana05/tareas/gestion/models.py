...
class Tarea (models.Model):
    ...
    #AutoField , da la funcion de que sea autoincrementable
    estadoOpciones= [('POR_HACER','POR_HACER'),('HACIENDO','HACIENDO'),('HECHO','HECHO')]
    id = models.AutoField(primary_key=True,unique=True, null=False)
    nombre  = models.CharField(max_length=100, null=False)#el nombre de la tarea debe ser unico ?
    ...
    class Meta:
        ...
        db_table='tareas'
        #el ordenamiento sera de manera descendente por la columna fechaVencimiento
